...
{{< section-container class="py-20 bg-gray-50" >}}
    <div class="max-w-6xl mx-auto">
        <h2 class="text-3xl font-bold text-center mb-12">Nasz zespół</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            {{< team-member
                name="Paweł Pitak"
                title="Chief Executive Officer"
                image="/images/company/pawel.jpg"
                linkedin="#"
            >}}
            {{< team-member
                name="Piotr Skorupski"
                title="Chief Executive Officer"
                image="/images/company/piotrek.jpg"
                linkedin="#"
            >}}
            {{< team-member
                name="Michał Nowotniak"
                title="Marketing Manager"
                image="/images/company/michal.jpg"
                linkedin="#"
            >}}
            {{< team-member
                name="Caspar Zych"
                title="Marketing Specialist"
                image="/images/company/caspar.jpg"
                linkedin="#"
            >}}
            {{< team-member
                name="Emilia Domańska"
                title="Content Creator"
                image="/images/company/emilia.jpg"
                linkedin="#"
            >}}
        </div>
    </div>
